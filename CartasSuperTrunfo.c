...
//Área para definição das variáveis para armazenar as propriedades das cidades
    ...
    float area1, PIB1, pib_bilhoes1, pib_em_reais1, densid_populacional1, PIB_per_capita1;
...
//Importante cadastrar uma carta e imprimir o resultado, pois evita cansar o usuário
    ...
    printf("Área da cidade em Km² (com ponto): \n");
    scanf("%f", &area1);

    printf("Qual o PIB? (em milhões com ponto)\n");
    scanf("%f", &PIB1);
...
//Área para exibição dos dados da cidade 1
    pib_bilhoes1 = PIB1 / 1000; //Transformar em bilhões de reais
    densid_populacional1 = populacao1 / area1;
    pib_em_reais1 = PIB1 * 1000000; //Converter para reais
    PIB_per_capita1 = pib_em_reais1 / populacao1;
    ...
    printf("PIB per Capita: %.2f reais\n", PIB_per_capita1); //Fim da impressão da carta 1

//Área para definição das variáveis para armazenar as propriedades da próxima cidade
    char estado2; 
    char codigo2[4], cidade2[50];
    int populacao2, pontos_turisticos2;
    float area2, PIB2, pib_bilhoes2, pib_em_reais2, densid_populacional2, PIB_per_capita2;
...
//Área para exibição dos dados da cidade 2
    pib_bilhoes2 = PIB2 / 1000; //Transformar em bilhões de reais
    densid_populacional2 = populacao2 / area2;
    pib_em_reais2 = PIB2 * 1000000; //Converter para reais
    PIB_per_capita2 = pib_em_reais2 / populacao2;
    ...
    printf("PIB per Capita: %.2f reais\n", PIB_per_capita2); //Fim da impressão da carta 2
